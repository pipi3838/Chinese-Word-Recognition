...
from ImgDataset import ImgDataset, TransferImgDataset
...
EPOCH = 100
device = 'cuda:0'
save_model_path = '/nfs/nas-5.1/wbcheng/CWR_models/Pretrain_Common'
...
dir_path = '/nfs/nas-5.1/wbcheng/Chinese_Word_Recognition/Pretrain_Common_Modified'

with open('./CommonWord2label.json', 'r', encoding='utf-8') as f:
    word2label = json.load(f)

dataset = TransferImgDataset(dir_path, word2label)
...
model.load_state_dict(torch.load('/nfs/nas-5.1/wbcheng/CWR_models/Pretrain_Common/{0}_loss.pth'))
